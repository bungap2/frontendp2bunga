						...
						<label for="">Jenis Barang</label>
                            ...
                            <div class="form-group">
                               <div class="form-line">
								...
								$sql = $koneksi -> query("select * from kategori_barang order by id");
								while ($data=$sql->fetch_assoc()) {
									echo "<option value='$data[id].$data[kategori_barang]'>$data[kategori_barang]</option>";
								}
								?>
								</select>
							...
							if (isset($_POST['simpan'])) {
								...
								$pecah_kategori = explode(".", $kategori_barang);
							
								$id = $pecah_kategori[0];
								$kategori_barang = $pecah_kategori[1];
								...
								$sql = $koneksi->query("insert into gudang (kode_barang, nama_barang, jenis_barang, kategori_barang, jumlah, satuan ) values('$kode_barang','$nama_barang','$jenis_barang', '$kategori_barang', '$jumlah','$satuan')");
